...
const faqs = [
  ...
  { q: 'Tem opções vegetarianas no cardápio?', a: 'Sim! Temos temakis e uramakis vegetarianos com pepino, abacate, legumes e muito mais. Consulte nosso cardápio completo para ver todas as opções.' },
