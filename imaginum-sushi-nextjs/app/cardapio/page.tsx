...
const cardapio = [
  { secao: 'Combinados', desc: 'Seleções especiais de sushi e sashimi com ingredientes frescos', emoji: '🍱', itens: [
  ...
  { secao: 'Temakis', desc: 'Cones artesanais de alga com arroz japonês preparados na hora', emoji: '🍣', itens: [
  ...
  { secao: 'Hot Rolls', desc: 'Uramakis empanados e crocantes, servidos quentinhos', emoji: '🔥', itens: [
  ...
  { secao: 'Sashimis', desc: 'Fatias de peixe fresco fatiadas na hora, sem arroz', emoji: '🐟', itens: [
  ...
  { secao: 'Entradas', desc: 'Para começar a refeição com o melhor da culinária japonesa', emoji: '🫘', itens: [
  ...
  { secao: 'Bebidas', desc: 'Bebidas selecionadas para acompanhar sua refeição', emoji: '🍵', itens: [
      ...
      <main style={{ paddingTop: '5rem', minHeight: '100vh' }}>
        <section className="section" style={{ paddingBottom: '2rem' }}>
          <div className="container">
            ...
            <p style={{ marginTop: '1rem', maxWidth: 560, fontSize: '1.05rem' }}>Ingredientes frescos selecionados diariamente. Disponível no salão, para retirada ou delivery pelo nosso app.</p>
          </div>
        </section>
        {cardapio.map((s, i) => (
