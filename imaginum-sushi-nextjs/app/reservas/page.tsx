      ...
      <main style={{ paddingTop: '6rem', minHeight: '100vh' }}>
        <section className="section">
          <div className="container" style={{ maxWidth: 700 }}>
            ...
            <p style={{ marginTop: '1rem', fontSize: '1.05rem' }}>Para garantir sua mesa, entre em contato pelo telefone ou WhatsApp. Recomendamos reservar com antecedência, especialmente nos fins de semana.</p>
